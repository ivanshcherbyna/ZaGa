	...
	class Redux_Framework_Lwp_config {
		...
		public function setSections() {
			...
			$footer_fields = array(
                ...
                array(
                    'title' => __('facebook link', THEME_OPT),
                    'type' => 'text',
                    'id' =>'fb-link'
                ),
                array(
                    'title' => __('twitter link', THEME_OPT),
                    'type' => 'text',
                    'id' =>'tw-link'
                ),
                array(
                    'title' => __('instagram link', THEME_OPT),
                    'type' => 'text',
                    'id' =>'ig-link'
                ),
			);
            $header_fields = array(
                array(
                    'title' => __('Header background', THEME_OPT),
                    'type' => 'media',
			...
			/* Set sections */
            $this->sections[] = array(
                'title'  => __( 'Homepage Header', THEME_OPT ),
                'icon'   => 'el-icon-cog',
